  ...
  return (
    <section className="relative min-h-screen flex items-center py-20 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20 dark:opacity-10">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 rounded-full bg-green-300 blur-3xl"></div>
        <div className="absolute top-2/3 right-1/4 w-72 h-72 rounded-full bg-orange-300 blur-3xl"></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-green-400/20 rounded-2xl blur-xl transform rotate-3"></div>
              <img
